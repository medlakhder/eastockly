...
<!---------------------------------------------------------------------->
 ...
 <center>
<form action="include/add_prod.php" method="post" enctype="multipart/form-data">
  ...
  <br>
  <button style="font-weight: bolder;background:white;border:1px solid white;color:#003873" name="add_prod" class="button_search" type="submit">

اضافة  <i style="font-size: 14px" class="fas fa-plus" ></i></button>
